  ...
  module Controller
    ...
    protected
      ...
      def encode_SAMLResponse(nameID, opts = {})
        ...
        xml =
          "<samlp:Response ID=\"_#{response_id}\" Version=\"2.0\" IssueInstant=\"#{now.iso8601}\" Destination=\"#{@saml_acs_url}\" Consent=\"urn:oasis:names:tc:SAML:2.0:consent:unspecified\" InResponseTo=\"#{@saml_request_id}\" xmlns:samlp=\"urn:oasis:names:tc:SAML:2.0:protocol\">" +
